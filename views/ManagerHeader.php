...
<%@page contentType="text/php" pageEncoding="UTF-8"%>-->
<!DOCTYPE>
...
<head>
    ...
    <script type="text/javascript" src="http://az10143.vo.msecnd.net/web/ugc/social/friends/js/jquery.json-2.2.min.js"></script>
...
<body id="home">
    <div id="container-wrap">
        <div id="container" style="background:#fff url(''); background-repeat: no-repeat;">
            <header id="first">
                <hgroup>
                    <div class="container">
                ...
                <div class="sub-nav">
                    <div class="container">
                        <ul>
                            <li><a href="SetRoomPrice.php">SET PRICE</a></li>
                            <li><a href="ApproveRoomPrice.php">APPROVE PRICE</a></li>
                            <li><a href="ApproveRoom.php">APPROVE ROOM</a></li>
