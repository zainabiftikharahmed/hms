            ...
            <div class="container">
                ...
                <div class="col-wrap">
                    ...
                    <div class="col ">
                        <div class="content-wrap ">
                            <h3>Reservations</h3>
                            <p><strong>Front Desk - </strong>030 44 55 00 66<br /><a href="mailto:l144035@lhr.nu.edu.pk">l144035@lhr.nu.edu.pk</a>
                        </div>
                    </div>
                    <div class="col ">
                        <div class="content-wrap ">
                            <h3>Public Relations</h3>
                            <p><strong>Public Relations:</strong><br />Chaudhry Waqar Ali<br><a href="mailto:l144035@lhr.nu.edu.pk">l144035@lhr.nu.edu.pk</a>
                        </div>
                    </div>
                </div>
            </div>
